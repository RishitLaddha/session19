...
def test_multiple_devices():
    """ it was wrongly written SmartDevice.device_count == 5 shouldnt be there it should be 13 and so i corrected it 
    and ran pytest again to get the desrired success in pytest test_smart_device.py """
